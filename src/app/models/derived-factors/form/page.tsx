...
export default function DerivedFactorFormLayoutPage() {
  ...
  return (
    <PlatformPageShell
      ...
      breadcrumbs={[
        ...
        { label: "Derived factor form layout" },
      ]}
      flush
      fill
    >
      <div className="shrink-0 px-4 pt-4 md:px-6">
        <PageHeader
          title="Derived factor form layout"
      ...
      <div className="min-h-0 flex-1">
        <EntityFormLayoutEditor
          workspaceSlug={WORKSPACE_SLUGS.DERIVED_FACTOR_FORM}
          adminKey={adminKey}
        />
      </div>
    </PlatformPageShell>
